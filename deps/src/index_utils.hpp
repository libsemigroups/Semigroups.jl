...
template <typename T> inline std::vector<T> vec_to_0_based(std::vector<T> const & v)
{
  std::vector<T> r;
  r.reserve(v.size());
  for (auto x : v)
...
template <typename T> inline std::vector<T> vec_to_1_based(std::vector<T> const & v)
{
  std::vector<T> r;
  r.reserve(v.size());
  for (auto x : v)
...
template <typename T> inline std::vector<T> vec_to_0_based_undef(std::vector<T> const & v)
{
  std::vector<T> r;
  r.reserve(v.size());
  for (auto x : v)
...
template <typename T> inline std::vector<T> vec_to_1_based_undef(std::vector<T> const & v)
{
  std::vector<T> r;
  r.reserve(v.size());
  for (auto x : v)
