...
namespace libsemigroups_julia {
  ...
  void define_knuth_bendix(jl::Module& m) {
    ...
    auto type
        = m.add_type<KB>("KnuthBendixRewriteTrie",
    ...
    // max_pending_rules
    type.method("max_pending_rules",
                [](KB const& self) -> size_t {
    ...
    type.method("check_confluence_interval",
                [](KB const& self) -> size_t {
                  return self.check_confluence_interval();
                });
    type.method("set_check_confluence_interval!",
                [](KB& self, size_t val) {
    ...
    // overlap_policy
    type.method("overlap_policy",
                [](KB const& self) -> KB::options::overlap {
                  return self.overlap_policy();
                });
    type.method("set_overlap_policy!",
                [](KB& self, KB::options::overlap val) {
    ...
    type.method("number_of_active_rules",
                [](KB const& self) -> size_t {
                  return self.number_of_active_rules();
                });
    type.method("number_of_inactive_rules",
                [](KB const& self) -> size_t {
                  return self.number_of_inactive_rules();
                });
    type.method("number_of_pending_rules",
                [](KB const& self) -> size_t {
    ...
    type.method("confluent",
                [](KB& self) -> bool { return self.confluent(); });
    ...
    type.method("number_of_generating_pairs",
                [](KB const& self) -> size_t {
                  return self.number_of_generating_pairs();
                });

    // presentation — return by copy
    type.method("presentation",
                [](KB const& self) -> Presentation<word_type> {
    ...
    m.method("kb_reduce",
             [](KB& self, jlcxx::ArrayRef<size_t> w) -> word_type {
    ...
    m.method(
        "kb_currently_contains",
        [](KB const& self, jlcxx::ArrayRef<size_t> u,
    ...
    // add_generating_pair!
    m.method("kb_add_generating_pair!",
             [](KB&                    self,
                jlcxx::ArrayRef<size_t> u,
                jlcxx::ArrayRef<size_t> v) {
               word_type uw(u.begin(), u.end());
               word_type vw(v.begin(), v.end());
               libsemigroups::knuth_bendix::add_generating_pair(
                   self, uw, vw);
             });
    ...
    m.method("kb_by_overlap_length!",
             [](KB& self) {
               libsemigroups::knuth_bendix::by_overlap_length(self);
             });

    // is_reduced
    m.method("kb_is_reduced",
             [](KB& self) -> bool {
    ...
    m.method(
        "kb_non_trivial_classes",
        [](KB& kb1, KB& kb2) -> std::vector<std::vector<word_type>> {
          return libsemigroups::knuth_bendix::non_trivial_classes(kb1, kb2);
        });
  }
